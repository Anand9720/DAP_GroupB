...
def plot_top_revenue_pie_chart(df):
    ...
    plt.axis('equal')
    plt.savefig('top_revenue_pie_chart_graph.png')
    plt.close()
    # Show the chart
    #plt.show()
...
def plot_top_yearly_revenues(df, n=10):
    ...
    plt.savefig('plot_top_yearly_revenues_graph.png')
    plt.close()
    # Show the plot
    #plt.show()
...
def plot_top_yearly_movies(df, n=20):
    ...
    plt.xticks(rotation=90)
    plt.savefig('plot_top_yearly_movies_graph.png')
    plt.close()
...
def plot_top_genres(df, column, n=15):
    ...
    plt.xticks(rotation=90)
    plt.savefig('plot_top_genres_graph.png')
    plt.close()
    #plt.show()
...
def plot_genre_revenue(df, genre_col, revenue_col):
    ...
    plt.savefig('plot_genre_revenue_graph.png')
    plt.close()
    #plt.show()
...
def plot_top_directors(df):
    ...
    plt.savefig('plot_top_directors_graph.png')
    plt.close()
